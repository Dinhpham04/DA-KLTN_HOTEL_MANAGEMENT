...
export class UpdateClientDto {
  ...
  @ApiPropertyOptional({ description: 'Client type (0=Not specified, 1=Individual, 2=Corporation, 3=Special Corporation)' })
  @IsOptional()
  @IsInt()
  @Min(0)
  @Max(3)
  ...
  @ApiPropertyOptional({ description: 'Client name', maxLength: 256 })
  @IsOptional()
  @IsString()
  @MaxLength(256)
  ...
  @ApiPropertyOptional({ description: 'Sex (1=Male, 2=Female, 9=Other)' })
  @IsOptional()
  @IsInt()
  readonly sex?: number;
  ...
  @ApiPropertyOptional({ description: 'Post-paid flag' })
  @IsOptional()
  @IsBoolean()
