...
- Man hinh quan ly shift dung ngay hien thi T+1, nhung truy van API theo ngay `displayDate - 1 day`.
...
- De giu dung logic legacy `clean_confirm`, FE hien thi `reportDate` nhung truy van task theo `cleaningDate = reportDate - 1 day`.
