...
function ClientEditPage() {
  ...
  const { data: client, isLoading } = useGetClientById({ clientId: clientIdNum })
  ...
  useEffect(() => {
    if (client) {
      const birthdayFormatted = client.birthday
  ...
  const updateClientMutation = useUpdateClient({
    onSuccess: () => {
      ...
      navigate({ to: `/clients/${clientId}/detail` })
    },
    onError: () => {
  ...
  return (
    <div className="box-border flex flex-col gap-[2.3rem] py-[2.3rem] common-container">
      ...
      <div className="flex items-center justify-between">
        ...
        <NButton onClick={() => navigate({ to: `/clients/${clientId}/detail` })}>Quay lại</NButton>
      </div>
              ...
              <CustomAccordionContent className="pb-0">
                <div className="flex flex-col px-[2rem] py-[1rem] gap-4">
                  ...
                  <div className="grid grid-cols-12 gap-4 items-center">
                    <Label className="col-span-2 text-right">Mã khách hàng</Label>
                    <div className="col-span-4">
                      <CustomInput value={String(client.clientId)} disabled />
                    </div>
                  </div>
          ...
          <div className="flex justify-center gap-4 mt-6">
            <CustomDialog
              ...
              trigger={
                ...
                >
                  {updateClientMutation.isPending ? 'Đang xử lý...' : 'Cập nhật'}
                </NButton>
              }
              title="Xác nhận cập nhật"
              content={
                <div className="p-4">
                  <p>Bạn có chắc chắn muốn cập nhật thông tin khách hàng này?</p>
                  <div className="flex justify-center gap-4 mt-4">
                    <DialogClose onClick={confirmUpdate}>
            ...
            />
            <NButton type="button" onClick={() => navigate({ to: `/clients/${clientId}/detail` })}>
              Hủy
            </NButton>
          </div>
        </form>
